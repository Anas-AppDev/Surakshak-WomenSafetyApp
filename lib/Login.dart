          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 40,),
                  Text("Log in", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Color(0xff785CFF), fontSize: 40),),
                  SizedBox(height: 50,),
                  Text("   Mail", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Color(0xff785CFF), fontSize: 20),),
                  SizedBox(height: 10,),
                  Form(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        SizedBox(height: 40,),
                        Text("   Password", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Color(0xff785CFF), fontSize: 20),),
                        SizedBox(height: 10,),
                        Container(
                          height: 60,
                          decoration: BoxDecoration(
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    prefixIcon: Icon(CupertinoIcons.lock, color: Color(0xff785CFF),),
                                    border: InputBorder.none,
                                    counterText: "",
                                  ),
                                  maxLength: 15,
                    ...
                    onTap: () async{
                      if (formKey.currentState!.validate()) {
                        try {
                          ...
                          QuerySnapshot querySnapshot = await firestore.doc("VerifiedUsers").collection("Users")
